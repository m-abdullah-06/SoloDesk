...
export function Modal({ open, onClose, title, children, size = "md" }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4">
      ...
      <div
        className={cn(
          "relative w-full bg-white shadow-xl animate-fade-up",
      ...
      >
        {title && (
          <div className="flex items-center justify-between p-5 border-b border-border sticky top-0 bg-white rounded-t-3xl md:rounded-t-2xl z-10">
